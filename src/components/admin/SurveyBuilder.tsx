...
const TEMPLATES: { emoji: string; name: string; questions: QuestionDraft[] }[] = [
  {
    ...
    questions: [
      { type: "star", prompt: "How would you rate this session?", options: [], order: 0 },
      { type: "poll", prompt: "What was the best part?", options: ["Content", "Speaker energy", "Examples", "Q&A"], order: 1 },
      { type: "text", prompt: "What would you change or improve?", options: [], order: 2 },
    ],
  },
  {
    emoji: "🎉",
    ...
    questions: [
      { type: "star", prompt: "How was the overall vibe?", options: [], order: 0 },
      { type: "poll", prompt: "Best part of the event?", options: ["People", "Food", "Activities", "Location"], order: 1 },
      { type: "star", prompt: "Would you come back next time?", options: [], order: 2 },
      { type: "text", prompt: "Any shoutouts or roasts?", options: [], order: 3 },
    ],
  },
  {
    emoji: "💼",
    name: "Team Retro",
    questions: [
      { type: "star", prompt: "How did this sprint feel overall?", options: [], order: 0 },
      { type: "poll", prompt: "Biggest blocker this sprint?", options: ["Unclear requirements", "Too many meetings", "Tech debt", "Other"], order: 1 },
      { type: "text", prompt: "What should we stop doing immediately?", options: [], order: 2 },
      { type: "text", prompt: "What should we keep doing?", options: [], order: 3 },
    ],
  },
];
